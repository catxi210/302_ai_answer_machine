...
const FormGenerator = <T extends FieldValues>({
  ...
  const renderTextarea = () => {
        ...
        <div className="flex items-end justify-between bg-background p-2">
          <div className="flex items-center gap-2">
            ...
            {showAction?.position === "bottom-left" && (
              <Button
                type="button"
                variant={textareaConfig.action?.buttonVariant ?? "default"}
                size="sm"
              ...
              >
                <LoaderRenderer
                  ...
                  statuses={{
                    default: {
                      icon: textareaConfig.action?.defaultIcon,
                      text: textareaConfig.action?.label,
                    },
                    loading: {
    ...
    return (
      <Label
        className={cn("flex flex-col gap-2", textareaConfig?.wrapperClassName)}
        htmlFor={`input-${id}`}
      >
        <div className="flex items-center gap-2">
          <span>{label}</span>
