...
ENV NEXT_PUBLIC_API_URL=$NEXT_PUBLIC_API_URL \
  ...
  NEXT_PUBLIC_DEFAULT_MODEL_NAME=$NEXT_PUBLIC_DEFAULT_MODEL_NAME \
  NEXT_PUBLIC_HIDE_BRAND=$NEXT_PUBLIC_HIDE_BRAND \
  NEXT_PUBLIC_LOG_LEVEL=$NEXT_PUBLIC_LOG_LEVEL \
  NEXT_PUBLIC_302_WEBSITE_URL_CHINA=$NEXT_PUBLIC_302_WEBSITE_URL_CHINA \
  NEXT_PUBLIC_302_WEBSITE_URL_GLOBAL=$NEXT_PUBLIC_302_WEBSITE_URL_GLOBAL \
  NEXT_PUBLIC_AUTH_PATH=$NEXT_PUBLIC_AUTH_PATH \
  NEXT_PUBLIC_IS_CHINA=$NEXT_PUBLIC_IS_CHINA \
  NEXT_PUBLIC_DEFAULT_LOCALE=$NEXT_PUBLIC_DEFAULT_LOCALE \
  NEXT_PUBLIC_AI_302_API_UPLOAD_URL=$NEXT_PUBLIC_AI_302_API_UPLOAD_URL
